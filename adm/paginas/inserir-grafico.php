...
<main role="main" class="container">
  <div class="jumbotron">
    ...
    <?php
      ...
      if (!empty($dados['salvar'])) {
        ...
        $img = "info-" . preg_replace('<\W+>', "-", $strl) . ".png";
        // echo "<pre>";
        // var_dump($dados);
        // echo "</pre>";
        // echo "<pre>";
        ...
        $query_obra = "INSERT INTO graficos (id_info, titulo, img_info) VALUES (:id_info, :titulo, :img_info)";
        $cad_obra = $conn->prepare($query_obra);
        $cad_obra->bindParam(':id_info', $dados['infografico'], PDO::PARAM_STR);
        $cad_obra->bindParam(':titulo', $dados['titulo'], PDO::PARAM_STR);
        $cad_obra->bindParam(':img_info', $img, PDO::PARAM_STR);
        $cad_obra->execute();
  ...
  <div class="form-group">
    <div class="form-group">
      ...
      <label for="id_info">Gráficos:</label>
    ...
    <label for="titulo">Título Gráfico:</label>
    <input type="text" class="form-control" name="titulo" id="titulo" placeholder="Título do Gráfico" autocomplete="off" autofocus required>
  </div>   
  <div class="form-group">
    <label for="upload">Imagem:</label>
    <input type="file" class="form-control-file" name="img_info[]" multiple="multiple" id="img_info">
  </div>
